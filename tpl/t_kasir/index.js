app.controller("kasirCtrl", function($scope, Data, toaster) {
  var tableStateRef;
  var control_link = "m_barang";
  $scope.title = "Transaksi Kasir";
  $scope.formTitle = "";
  $scope.displayed = [];
  $scope.form = {
    password: ""
  ...
  $scope.getkategori = function() {
    Data.get("m_kategori/index").then(function(data) {
      $scope.listkategori = data.data.list;
    });
  };

  $scope.getsatuan = function() {
    Data.get("m_satuan/index").then(function(data) {
